      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-5 mb-9">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900">CHỌN ĐÚNG ĐIỂM ĐẾN - KIẾN TẠO TƯƠNG LAI</h2>
            <p className="text-slate-500 mt-3 max-w-2xl">Khám phá điểm đến phù hợp với mục tiêu và tương lai của bạn</p>
          </div>
        ...
        <div className="relative">
          <div ref={railRef} className="destination-rail flex gap-6 md:gap-8 overflow-x-auto pb-5 snap-x snap-mandatory scroll-smooth">
            {content.destinations.map((item, idx) => (
              <a href={item.link || '#'} key={idx} className="snap-start shrink-0 w-[150px] md:w-[178px] group text-center">
